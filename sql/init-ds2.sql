...
CREATE DATABASE IF NOT EXISTS payment_merchant
...
CREATE TABLE IF NOT EXISTS notify_record (
    ...
    retry_count INT,
    status VARCHAR(16),
    UNIQUE KEY uk_notify_trade (merchant_id, out_trade_no),
    INDEX idx_notify_status (status, next_retry_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
USE payment_order_0;
